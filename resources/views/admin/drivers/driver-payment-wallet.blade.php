 ...
 <div class="row">
            ...
            <div class="col-xl-6 col-md-4 col-6" style="margin: 25px">
                <div class="box box-body flex">
                    ...
                    <div>
                 <span><b>@lang('view_pages.bank_name') : </b>{{$bankInfo ? $bankInfo->bank_name : "-"}}</span><br>
                        <span><b>@lang('view_pages.bank_code')  : </b>{{$bankInfo ? $bankInfo->bank_code : "-"}}</span><br>
                        <span><b>@lang('view_pages.account_holder_name') : </b>{{$bankInfo ? $bankInfo->account_name : "-"}}</span><br>
                        <span><b>@lang('view_pages.account_number') : </b>{{$bankInfo ? $bankInfo->account_no : "-"}}</span><br>
                    </div>
                </div>
          </div>
        </div>
