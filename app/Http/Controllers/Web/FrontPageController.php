...
class FrontPageController extends Controller
{
    ...
    public function index()
    {
        ...
        if($conditional_host[0] =='delivery-admin'||$conditional_host[0] =='tagxi-delivery-admin'){
        ...
        if($conditional_host[0] =='delivery-dispatch'||$conditional_host[0] =='tagxi-delivery-dispatch'){
